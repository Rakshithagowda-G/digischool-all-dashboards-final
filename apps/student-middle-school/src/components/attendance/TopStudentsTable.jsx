...
export default function TopStudentsTable({ subjectWiseData = [] }) {
  return (
      ...
      >
        {subjectWiseData.length > 0 ? (
          <table className="w-full">
            ...
            <tbody>
              {subjectWiseData.map((course, index) => (
                <tr
          ...
          <div className="text-center py-12">
            <p className="text-text-muted font-poppins">No subject-wise attendance data available</p>
          </div>
        )}
      </div>
    </div>
