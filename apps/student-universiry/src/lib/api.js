...
// Default to University Student (STU001) for this dashboard
...
// E-Library APIs
export const getLibraryBooks = (educationLevel = 'university') =>
    fetch(`${API_BASE_URL}/library/books?educationLevel=${educationLevel}`).then(handleResponse);

export const getLibraryNewArrivals = (educationLevel = 'university') =>
