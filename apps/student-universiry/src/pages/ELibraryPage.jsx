    ...
    const fetchLibraryData = async () => {
      try {
        ...
        const [booksData, newArrivalsData] = await Promise.all([
          getLibraryBooks('university'),
          getLibraryNewArrivals('university')
        ]);
    ...
    return (
      <PageWithSidebar>
        <div className="flex flex-1 min-w-0 h-full p-2 sm:p-3 md:p-4 lg:p-6">
          <div className={`w-full h-full rounded-xl shadow-lg flex items-center justify-center ${!darkMode ? 'bg-slate-100' : ''}`}>
